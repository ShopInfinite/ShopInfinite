      ...
      <section className="bg-white dark:bg-slate-800" id="contact">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="text-center mb-8">
            <p className="text-base font-semibold uppercase tracking-wide text-orange-600 dark:text-orange-200 mt-20">
              Contact
            </p>
                ...
                <div className="card max-w-6xl p-5 md:p-12" id="form">
                  ...
                  <form id="contactForm" onSubmit={handleSubmit}>
                    ...
                    <div className="text-center">
                      <button
                        type="submit"
                        className="w-full bg-orange-500 text-white px-6 py-3 font-xl rounded-md"
                      >
                        Send Message
                      </button>
                    </div>

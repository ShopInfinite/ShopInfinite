...
function Profile() {
  const [profile, setProfile] = useState({
    name: 'Nidal Raed',
    location: 'Amman',
    profileImage: 'https://media.licdn.com/dms/image/D4D03AQGc5hEVDZnwGg/profile-displayphoto-shrink_800_800/0/1691223900748?e=2147483647&v=beta&t=z9zxzIw5amqztpFwlvL1GO2znCYhK1_3gq5q1IvWt5o',
  });
  ...
  const handleProfileSave = (updatedProfile) => {
    ...
    axios.put('http://localhost:3001/profile', updatedProfile)
      .then((response) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-1">
          <div className="bg-white p-4 rounded-lg shadow-md">
            ...
            <p className="text-gray-700 mt-2">Location: {profile.location}</p>
          </div>
        </div>
        <div className="md:col-span-2">
          {isEditFormVisible ? (
            ...
            <div className="bg-white p-4 mt-6 rounded-lg shadow-md">
              ...
              <Link to="/favorite"><button type="button" class="focus:outline-none text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900">VIEW ALL</button></Link>

  ...
  return (
    <div className="nav">
      <nav className="w-full bg-orange-500 h-fit overflow-hidden">
        <div className="py-4 lg:px-8 px-4 max-w-8xl h-16 m-auto text-white flex items-center justify-between">
          <div className="flex items-center">
            <div>
             <a href='/profile'><h1 className="lg:text-2xl text-xl mx-10 uppercase tracking-wider cursor-pointer font-bold">
                ShopInfinite
              </h1></a> 
            </div>
      ...
      {mobileMenuOpen && (
        <div
          id="mobileNav"
          className="fixed flex flex-col gap-8 pt-16 px-4 text-xl uppercase bg-white h-full inset-0 top-16 w-full ease-in-out duration-500 cursor-pointer"
        >
         <a href="/"> <span>Home</span></a>
         <a href="/contact">  <span>Contact US</span></a>
         <a href="/about"> <span>About Us</span></a>
          <a href='/login'><button className="text-white bg-orange-700 px-4 py-2 rounded-md hover.bg-blue-600">
            Login / Sign up
          </button></a>
        </div>
      )}
